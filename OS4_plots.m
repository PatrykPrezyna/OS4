...
for i=1:length(Design)
    ...
    Design_variable_names = cat(1, Design_variable_names, ["Chassis Pax"]);
    ...
    %Design variable EB
    color(7,i)=Design(i).Number_of_bikes;
    Design_variable_names = cat(1, Design_variable_names, ["Number_of_bikes"]);
    color(8,i)=Design(i).Battery_capacity_EB;
    Design_variable_names = cat(1, Design_variable_names, ["Battery capacity bike"]);
    color(9,i)= Design(i).Frame_weight_EB;
    Design_variable_names = cat(1, Design_variable_names, ["Frame_weight_EB"]);
    color(10,i)=Design(i).Battery_charger_power_EB;
    Design_variable_names = cat(1, Design_variable_names, ["Battery_charger_power_EB"]);
    color(11,i)=Design(i).Motor_power_EB;
    Design_variable_names = cat(1, Design_variable_names, ["Motor_power_EB"]);
end
